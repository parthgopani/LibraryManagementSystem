            ...
            <ul class="nav navbar-nav float-right">
              <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail">             </i></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="message_from_librarian"><i class="ft-book"></i> Read Mail</a></div>
                </div>
              </li>
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="images/user.png" alt="avatar"><i></i></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="images/user.png" alt="avatar"><span class="user-name text-bold-700 ml-1"><?php echo $_SESSION["username"]; ?></span></span></a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" nav-item"><a href="my_issued_books.php"><i class="ft-home"></i><span class="menu-title" data-i18n="">My Issued Books</span></a>
          </li>
          <li class=" nav-item"><a href="search_books.php"><i class="ft-pie-chart"></i><span class="menu-title" data-i18n="">Search Books</span></a>
          </li>
